...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        # Create Workouts
        Workout.objects.create(name='Hero HIIT', description='High intensity workout for heroes', duration=40)
        Workout.objects.create(name='Power Lift', description='Strength training for super strength', duration=60)
